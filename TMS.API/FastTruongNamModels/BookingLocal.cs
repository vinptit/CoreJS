...
namespace TMS.API.FastTruongNamModels
{
    public partial class BookingLocal
    {
        public BookingLocal()
        {
            BookingLocalAttachedFiles = new HashSet<BookingLocalAttachedFiles>();
            BookingLocalRoutine = new HashSet<BookingLocalRoutine>();
        }
        ...
        public virtual ICollection<BookingLocalAttachedFiles> BookingLocalAttachedFiles { get; set; }
        public virtual ICollection<BookingLocalRoutine> BookingLocalRoutine { get; set; }
    }
}
