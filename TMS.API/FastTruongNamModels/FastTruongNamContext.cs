...
{
    public partial class FastTruongNamContext : DbContext
    {
        public FastTruongNamContext()
        {
        }

        public FastTruongNamContext(DbContextOptions<FastTruongNamContext> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<CustomerBookingRequest> CustomerBookingRequest { get; set; }
        public virtual DbSet<CustomerBookingRequestDetail> CustomerBookingRequestDetail { get; set; }
        public virtual DbSet<CustomerShippingInstruction> CustomerShippingInstruction { get; set; }
        public virtual DbSet<CustomerShippingInstructionDetail> CustomerShippingInstructionDetail { get; set; }
        ...
        public virtual DbSet<VATMaxFkey> VATMaxFkey { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AMSDeclaration>(entity =>
            {
                ...
                entity.Property(e => e.ACIFileBy).HasMaxLength(50);

                entity.Property(e => e.ADDITIONAL_REMARK).HasMaxLength(255);

                entity.Property(e => e.AMSFileBy).HasMaxLength(50);
                ...
                entity.Property(e => e.ISFFileBy).HasMaxLength(50);
            ...
            modelBuilder.Entity<AcsCashFlowViewDetail>(entity =>
            {
                ...
                entity.Property(e => e.ExAccountRef).HasMaxLength(2000);
            ...
            modelBuilder.Entity<AcsSetlementPayment>(entity =>
            {
                ...
                entity.Property(e => e.AdvListNo).HasMaxLength(500);
                ...
                entity.Property(e => e.OldSltContactID).HasMaxLength(255);

                entity.Property(e => e.PARTNERID).HasMaxLength(250);
            ...
            modelBuilder.Entity<AcsSetlementPaymentAttachedFiles>(entity =>
            {
                ...
                entity.Property(e => e.FILENAMEFIREBASE).HasMaxLength(500);
            ...
            modelBuilder.Entity<ActiveUsers>(entity =>
            {
                ...
                entity.Property(e => e.EXPIRATION).HasDefaultValueSql("((0))");
            ...
            modelBuilder.Entity<AdvancePaymentRequest>(entity =>
            {
                ...
                entity.Property(e => e.AdvHBL).HasMaxLength(50);
                ...
                entity.Property(e => e.OLDADVCONTACTID).HasMaxLength(255);
            ...
            modelBuilder.Entity<AdvanceRequest>(entity =>
            {
                ...
                entity.HasOne(d => d.Payee)
                    .WithMany(p => p.AdvanceRequest)
                    .HasForeignKey(d => d.PayeeID)
                    .HasConstraintName("FK_AdvanceRequest_Partners");
            });
            ...
            modelBuilder.Entity<BookingContainer>(entity =>
            {
                ...
                entity.HasOne(d => d.Trans)
                    ...
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("BookingContainer_FK00");
            });

            modelBuilder.Entity<BookingLocal>(entity =>
            {
                entity.HasKey(e => e.BkgID)
                    .HasName("aaaaaBookingLocal_PK")
                    .IsClustered(false);

                entity.HasIndex(e => e.AgentID, "AgentID");

                entity.HasIndex(e => e.BkgID, "BkgID");
            ...
            modelBuilder.Entity<BookingLocalAttachedFiles>(entity =>
            {
                ...
                entity.HasOne(d => d.BKNONavigation)
                    .WithMany(p => p.BookingLocalAttachedFiles)
                    .HasForeignKey(d => d.BKNO)
                    .HasConstraintName("FK_BookingLocalAttachedFiles_BookingLocal");
            });
            ...
            modelBuilder.Entity<BookingLocalRoutine>(entity =>
            {
                ...
                entity.HasOne(d => d.RequestNoNavigation)
                    .WithMany(p => p.BookingLocalRoutine)
                    .HasForeignKey(d => d.RequestNo)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("FK_BookingLocalRoutine_BookingLocal");
            });
            ...
            modelBuilder.Entity<BookingRateRequest>(entity =>
            {
                ...
                entity.HasOne(d => d.Bkg)
                    .WithMany()
                    .HasForeignKey(d => d.BkgID)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("BookingRateRequest_FK00");
            ...
            modelBuilder.Entity<ContactsList>(entity =>
            {
                ...
                entity.Property(e => e.DAlias).HasMaxLength(255);
                ...
                entity.Property(e => e.cAlias).HasMaxLength(255);
            ...
            {
                entity.HasKey(e => e.BookingRequestId)
                    .HasName("PK__Customer__68EDFCC70AEC72A9");

                entity.Property(e => e.BookingRequestId)
                    .HasColumnType("numeric(18, 0)")
                    .ValueGeneratedOnAdd();

                entity.Property(e => e.CargoReadyDate).HasColumnType("datetime");
                ...
                entity.Property(e => e.EmtpyReturnAt).HasMaxLength(50);
                ...
                entity.Property(e => e.PickupAt).HasMaxLength(50);
            ...
            modelBuilder.Entity<CustomerBookingRequestDetail>(entity =>
            {
                entity.HasKey(e => e.BookingRequestDetailId)
                    .HasName("PK__Customer__97F00BFF0CC22EB2");

                entity.Property(e => e.BookingRequestDetailId)
                    .HasColumnType("numeric(18, 0)")
                    .ValueGeneratedOnAdd();

                entity.Property(e => e.BookingRequestId).HasColumnType("numeric(18, 0)");

                entity.Property(e => e.ContainerType).HasMaxLength(50);

                entity.Property(e => e.DescriptionOfGoods).HasMaxLength(500);

                entity.Property(e => e.PO).HasMaxLength(50);

                entity.HasOne(d => d.BookingRequest)
                    .WithMany(p => p.CustomerBookingRequestDetail)
                    .HasForeignKey(d => d.BookingRequestId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_CustomerBookingRequestDetailCustomerBookingRequestDetail");
            });

            modelBuilder.Entity<CustomerShippingInstruction>(entity =>
            {
                entity.Property(e => e.CustomerShippingInstructionID)
                    .HasColumnType("numeric(18, 0)")
                    .ValueGeneratedOnAdd();
                ...
                entity.Property(e => e.NotifyParty).HasMaxLength(500);
            ...
            modelBuilder.Entity<CustomerShippingInstructionDetail>(entity =>
            {
                entity.Property(e => e.CustomerShippingInstructionDetailId)
                    .HasColumnType("numeric(18, 0)")
                    .ValueGeneratedOnAdd();
                ...
                entity.Property(e => e.CustomerShippingInstructionID).HasColumnType("numeric(18, 0)");

                entity.Property(e => e.DescriptionOfGoods).HasMaxLength(250);

                entity.Property(e => e.PO).HasMaxLength(50);

                entity.Property(e => e.SealNo).HasMaxLength(50);

                entity.HasOne(d => d.CustomerShippingInstruction)
                    .WithMany(p => p.CustomerShippingInstructionDetail)
                    .HasForeignKey(d => d.CustomerShippingInstructionID)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_CustomerShippingInstructionCustomerShippingInstructionDetail");
            });
            ...
            modelBuilder.Entity<DataSourceSetup>(entity =>
            {
                ...
                entity.Property(e => e.CondStatement).HasMaxLength(4000);
            ...
            modelBuilder.Entity<FormControlList>(entity =>
            {
                ...
                entity.Property(e => e.ControlCaptionSND).HasMaxLength(1000);
            ...
            modelBuilder.Entity<FunctionListFieldCompact>(entity =>
            {
                ...
                entity.Property(e => e.FieldReplace).HasMaxLength(4000);

                entity.Property(e => e.FieldStatement).HasMaxLength(4000);
            ...
            modelBuilder.Entity<HAWB>(entity =>
            {
                ...
                entity.Property(e => e.EDOStatus).HasMaxLength(150);
                ...
                entity.Property(e => e.RECALLREASON).HasMaxLength(50);
                ...
                entity.Property(e => e.SpecialInstruction).HasMaxLength(1000);
            ...
            modelBuilder.Entity<InvoiceForm>(entity =>
            {
                ...
                entity.Property(e => e.FORM_TYPE_ID_IHOADON).HasMaxLength(255);

                entity.Property(e => e.HBLdetail).HasDefaultValueSql("((0))");

                entity.Property(e => e.ID_IHOADON).HasMaxLength(255);
            ...
            modelBuilder.Entity<InvoiceReference>(entity =>
            {
                ...
                entity.Property(e => e.ReceiverRead).HasDefaultValueSql("((0))");
            ...
            modelBuilder.Entity<Partners>(entity =>
            {
                ...
                entity.Property(e => e.ACCESSAPI).HasDefaultValueSql("((0))");
                ...
                entity.Property(e => e.CONFIRMREGISTER).HasDefaultValueSql("((0))");
                ...
                entity.Property(e => e.MAPFEECODE).HasMaxLength(250);
            ...
            modelBuilder.Entity<PartnersCargo>(entity =>
            {
                ...
                entity.Property(e => e.LockedCC).HasDefaultValueSql("((0))");

                entity.Property(e => e.LockedCS).HasDefaultValueSql("((0))");

                entity.Property(e => e.LockedDate).HasColumnType("datetime");

                entity.Property(e => e.LockedDateCC).HasColumnType("datetime");

                entity.Property(e => e.LockedDateCS).HasColumnType("datetime");

                entity.Property(e => e.LockedDateFN).HasColumnType("datetime");

                entity.Property(e => e.LockedDateTT).HasColumnType("datetime");

                entity.Property(e => e.LockedFN).HasDefaultValueSql("((0))");

                entity.Property(e => e.LockedTT).HasDefaultValueSql("((0))");
                ...
                entity.Property(e => e.UnlockUser).HasMaxLength(50);

                entity.Property(e => e.UnlockUserCC).HasMaxLength(50);

                entity.Property(e => e.UnlockUserCS).HasMaxLength(50);

                entity.Property(e => e.UnlockUserFN).HasMaxLength(50);

                entity.Property(e => e.UnlockUserTT).HasMaxLength(50);

                entity.Property(e => e.UnlockedDate).HasColumnType("datetime");

                entity.Property(e => e.UnlockedDateCC).HasColumnType("datetime");

                entity.Property(e => e.UnlockedDateCS).HasColumnType("datetime");

                entity.Property(e => e.UnlockedDateFN).HasColumnType("datetime");

                entity.Property(e => e.UnlockedDateTT).HasColumnType("datetime");
            ...
            modelBuilder.Entity<ProfitShares>(entity =>
            {
                ...
                entity.HasOne(d => d.HAWBNONavigation)
                    .WithMany(p => p.ProfitShares)
                    .HasForeignKey(d => d.HAWBNO)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("ProfitShares_FK00");

                entity.HasOne(d => d.Partner)
                    .WithMany(p => p.ProfitShares)
                    .HasForeignKey(d => d.PartnerID)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("ProfitShares_FK01");
            });
            ...
            {
                entity.HasKey(e => e.IDKey)
                    .HasName("PK__STAFFLOC__939E78BB3F93AE63");
            ...
            modelBuilder.Entity<Services>(entity =>
            {
                ...
                entity.Property(e => e.TASKREGISTERID).HasMaxLength(300);
            ...
            modelBuilder.Entity<TASK>(entity =>
            {
                ...
                entity.Property(e => e.FILENAMEFIREBASE_1).HasMaxLength(500);

                entity.Property(e => e.FILENAMEFIREBASE_2).HasMaxLength(500);

                entity.Property(e => e.FILENAMEFIREBASE_3).HasMaxLength(500);

                entity.Property(e => e.FILENAMEFIREBASE_4).HasMaxLength(500);

                entity.Property(e => e.FINISHDATE).HasColumnType("datetime");

                entity.Property(e => e.FileExt).HasMaxLength(50);

                entity.Property(e => e.FileExt_1).HasMaxLength(50);

                entity.Property(e => e.FileExt_2).HasMaxLength(50);

                entity.Property(e => e.FileExt_3).HasMaxLength(50);

                entity.Property(e => e.FileExt_4).HasMaxLength(50);

                entity.Property(e => e.FileName).HasMaxLength(50);

                entity.Property(e => e.FileName_1).HasMaxLength(50);

                entity.Property(e => e.FileName_2).HasMaxLength(50);

                entity.Property(e => e.FileName_3).HasMaxLength(50);

                entity.Property(e => e.FileName_4).HasMaxLength(50);

                entity.Property(e => e.GROUPID).HasMaxLength(50);

                entity.Property(e => e.GROUPMANAGER).HasMaxLength(50);

                entity.Property(e => e.HBLNo).HasMaxLength(50);

                entity.Property(e => e.HM_BILLTYPE).HasMaxLength(15);

                entity.Property(e => e.HM_CARRIERNAME).HasMaxLength(150);

                entity.Property(e => e.HM_GETBILLADDRESS).HasMaxLength(550);

                entity.Property(e => e.HM_GETBILLCELLNO).HasMaxLength(15);

                entity.Property(e => e.HM_GETBILLCONTACT).HasMaxLength(250);

                entity.Property(e => e.HM_GETBILLDISTRICT).HasMaxLength(25);

                entity.Property(e => e.HM_INVOICENO).HasMaxLength(25);

                entity.Property(e => e.HM_ONBOARDDATE).HasColumnType("datetime");

                entity.Property(e => e.HM_PACKAGE).HasMaxLength(50);

                entity.Property(e => e.HM_REQUESTEREMAIL).HasMaxLength(250);

                entity.Property(e => e.HM_REQUESTERNAME).HasMaxLength(50);
                ...
                entity.Property(e => e.ORIGINTASKID).HasColumnType("numeric(18, 0)");

                entity.Property(e => e.PROBLEMNAME).HasMaxLength(500);

                entity.Property(e => e.REPONSEMESSAGE).HasMaxLength(500);

                entity.Property(e => e.RESOLUTION).HasMaxLength(3000);

                entity.Property(e => e.RETURNEDON).HasColumnType("datetime");

                entity.Property(e => e.RETURNEDREASON).HasMaxLength(500);
            ...
            modelBuilder.Entity<TASKREGISTERS>(entity =>
            {
                ...
                entity.Property(e => e.HM_ISGETBILL).HasDefaultValueSql("((0))");
            ...
            modelBuilder.Entity<TasksList>(entity =>
            {
                ...
                entity.Property(e => e.ISSENDSMS).HasDefaultValueSql("((0))");
            ...
            modelBuilder.Entity<TransactionDetails>(entity =>
            {
                ...
                entity.Property(e => e.ARRIVEPICKUPEMPTYON).HasColumnType("datetime");
                ...
                entity.Property(e => e.ISFINISHED).HasDefaultValueSql("((0))");
                ...
                entity.Property(e => e.PARKINGREMOCON).HasColumnType("datetime");

                entity.Property(e => e.PARKINGREMOCREASON).HasMaxLength(500);

                entity.Property(e => e.PICKUPEMPTYON).HasColumnType("datetime");
                ...
                entity.Property(e => e.REASONCANTDELIVER).HasMaxLength(500);

                entity.Property(e => e.REASONCANTPICKUP).HasMaxLength(500);

                entity.Property(e => e.RELEASEREMOCON).HasColumnType("datetime");
                ...
                entity.Property(e => e.TKCANTDELIVERDON).HasMaxLength(500);

                entity.Property(e => e.TKCANTPICKUPDON).HasColumnType("datetime");
                ...
                entity.Property(e => e.TKFinishedOn).HasColumnType("datetime");
                ...
                entity.Property(e => e.TROUBLEMESSAGE).HasMaxLength(1000);
                ...
                entity.Property(e => e.WARNINGTYPE).HasMaxLength(50);
            ...
            modelBuilder.Entity<Transactions>(entity =>
            {
                ...
                entity.Property(e => e.Starus).HasMaxLength(100);
            ...
            modelBuilder.Entity<VATInvoice>(entity =>
            {
                ...
                entity.Property(e => e.AttachDescription).HasMaxLength(500);
            ...
            {
                entity.HasKey(e => new { e.ID, e.InvoiceNo, e.Description, e.HBLNo, e.No })
                    .HasName("aaaaaVATInvoiceDetail_PK")
                    .IsClustered(false);
            ...
            modelBuilder.Entity<VATMaxFkey>(entity =>
            {
                entity.HasNoKey();
            ...
            modelBuilder.Entity<YourCompany>(entity =>
            {
                ...
                entity.Property(e => e.APIKEYGPS).HasMaxLength(50);
                ...
                entity.Property(e => e.WEBSITEELECTRONICDOCUMENT).HasMaxLength(250);
