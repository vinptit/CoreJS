...
namespace TMS.API.FastTruongNamModels
{
    public partial class PartnersCargo
    {
        ...
        public bool? LockedCS { get; set; }
        public DateTime? LockedDateCS { get; set; }
        public string UnlockUserCS { get; set; }
        public DateTime? UnlockedDateCS { get; set; }
        public bool? LockedTT { get; set; }
        public DateTime? LockedDateTT { get; set; }
        public string UnlockUserTT { get; set; }
        public DateTime? UnlockedDateTT { get; set; }
        public bool? LockedCC { get; set; }
        public DateTime? LockedDateCC { get; set; }
        public string UnlockUserCC { get; set; }
        public DateTime? UnlockedDateCC { get; set; }
        public bool? LockedFN { get; set; }
        public DateTime? LockedDateFN { get; set; }
        public string UnlockUserFN { get; set; }
        public DateTime? UnlockedDateFN { get; set; }
